							...
							<td>
								<select name="xCveRegiones" class="captura" onchange="recargaR();">
									...
									<%
									   ...
									   {
									   %>
									   <option value="<%=rs.getInt("cve_regiones")%>" <%=rs.getInt("cve_regiones")==
									   	cveRegiones?"selected":""%>> <%=rs.getString("nombre")%></option>
									   	<%
									    }
									    rs.close();
									    rs = null;
							...
							<td>
								<select name="xCveEstado" class="captura" onchange="recargaE();">
									...
									<%
									   ...
									   %>
									   <option value="<%=rs.getInt("cve_estados")%>" <%=rs.getInt("cve_estados")==
									   	cveEstado ? "selected":""%>><%=rs.getString("nombre")%></option>
									   	<%
									    }
									    rs.close();
									    rs = null;
