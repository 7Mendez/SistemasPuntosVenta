...
<!-- Navigation -->
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow ">
	  <div class="container">
	    <a  class="navbar-brand" href="index1.jsp">Sistema Comercio</a>
	    <a  class="navbar-brand" href="index1.jsp">Administrador</a>
	  </div>
	</nav>
</head>
	      ...
	      <div class="col-12 text-center">
	      	...
	      	<div class="row">
			    ...
			    <div class="col-sm-6 ">
			      ...
			      <div class="card h-30">
			        <div class="card-body">
			          <h5 class="card-title"><a href="puntosVentas.jsp">Puntos De Venta</a> </h5>
			        </div>
			      </div>
			    </div>
			    ...
			    <div class="col-sm-6 ">
			      ...
			      <div class="card h-30">
			        <div class="card-body">
			          <h5 class="card-title"><a href="usuarios.jsp">Usuarios</a> </h5>
			        </div>
			      </div>
			    </div>
